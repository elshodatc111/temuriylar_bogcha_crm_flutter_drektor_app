...
class AllChildWidget extends StatefulWidget {
  const AllChildWidget({super.key});

  @override
  State<AllChildWidget> createState() => _AllChildWidgetState();
}

class _AllChildWidgetState extends State<AllChildWidget>with SingleTickerProviderStateMixin {
  ...
  Future<void> _fetchChildren() async {
    ...
    try {
      final uri = Uri.parse('$baseUrl/child-all');
