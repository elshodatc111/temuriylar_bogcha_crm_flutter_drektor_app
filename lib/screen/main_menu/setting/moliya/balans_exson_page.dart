...
class BalansExsonPage extends StatefulWidget {
  final int maxNaqt;
  final int maxCard;
  final int maxShot;
  const BalansExsonPage({super.key, required this.maxNaqt, required this.maxCard, required this.maxShot});

  @override
  State<BalansExsonPage> createState() => _BalansExsonPageState();
}

class _BalansExsonPageState extends State<BalansExsonPage> {
  ...
  Future<void> _submit() async {
    ...
    try {
      final uri = Uri.parse('$baseUrl/moliya-exson');
