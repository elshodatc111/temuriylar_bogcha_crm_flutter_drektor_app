...
class BalansXarajatPage extends StatefulWidget {
  final int maxNaqt;
  final int maxCard;
  final int maxShot;
  const BalansXarajatPage({super.key, required this.maxNaqt, required this.maxCard, required this.maxShot});

  @override
  State<BalansXarajatPage> createState() => _BalansXarajatPageState();
}

class _BalansXarajatPageState extends State<BalansXarajatPage> {  final _formKey = GlobalKey<FormState>();
...
Future<void> _submit() async {
  ...
  try {
    final uri = Uri.parse('$baseUrl/moliya-xarajat');
